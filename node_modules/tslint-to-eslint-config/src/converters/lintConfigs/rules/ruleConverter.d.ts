 ...
 */
export declare type RuleConverterOptions = Pick<TSLintRuleOptions, "ruleArguments">;
/**
 * Attempts to convert the options for a TSLint rule into the ESLint equivalents.
 */
export declare type RuleConverter = (tslintRule: RuleConverterOptions) => ConversionError | ConversionResult;
/**
 ...
 */
export declare type ConvertedRuleChanges = {
    /**
