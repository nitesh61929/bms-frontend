(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["features-admin-dashboard-admin-dashboard-module"], {
    ...
    /***/
    function srcAppFeaturesAdminDashboardAdminDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _components_admin_dashboard_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./components/admin-dashboard.component */
      "./src/app/features/admin-dashboard/components/admin-dashboard.component.ts");
      /* harmony import */


      var _containers_admin_dashboard_container_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./containers/admin-dashboard-container.component */
    ...
    /***/
    function srcAppFeaturesAdminDashboardAdminDashboardRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _containers_admin_dashboard_container_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./containers/admin-dashboard-container.component */
      "./src/app/features/admin-dashboard/containers/admin-dashboard-container.component.ts");
      ...
      var routes = [{
        ...
        children: [{
          ...
          loadChildren: function loadChildren() {
            ...
            /*! import() | modules-owners-owner-module */
            "modules-owners-owner-module").then(__webpack_require__.bind(null,
            /*! ./modules/owners/owner.module */
            "./src/app/features/admin-dashboard/modules/owners/owner.module.ts")).then(function (m) {
    ...
    /***/
    function srcAppFeaturesAdminDashboardComponentsAdminDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _shared_admin_navigation_bar_admin_navigation_bar_admin_navigation_bar_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ../../../shared/admin-navigation-bar/admin-navigation-bar/admin-navigation-bar.component */
      ...
      AdminDashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [_shared_admin_navigation_bar_admin_navigation_bar_admin_navigation_bar_component__WEBPACK_IMPORTED_MODULE_1__["AdminNavigationBarComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"]],
        encapsulation: 2
      });
      /*@__PURE__*/
    ...
    /***/
    function srcAppFeaturesAdminDashboardContainersAdminDashboardContainerComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AdminDashboardContainerComponent", function () {
        return AdminDashboardContainerComponent;
      });
      /* harmony import */
      ...
      var _components_admin_dashboard_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ../components/admin-dashboard.component */
      "./src/app/features/admin-dashboard/components/admin-dashboard.component.ts");

      var AdminDashboardContainerComponent = /*#__PURE__*/function () {
        function AdminDashboardContainerComponent() {
          _classCallCheck(this, AdminDashboardContainerComponent);
        }

        _createClass(AdminDashboardContainerComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);
      ...
      AdminDashboardContainerComponent.ɵfac = function AdminDashboardContainerComponent_Factory(t) {
        return new (t || AdminDashboardContainerComponent)();
      };

      AdminDashboardContainerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: AdminDashboardContainerComponent,
        selectors: [["app-admin-dashboard-container"]],
        decls: 1,
        vars: 0,
        template: function AdminDashboardContainerComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "app-admin-dashboard");
          }
        },
        directives: [_components_admin_dashboard_component__WEBPACK_IMPORTED_MODULE_1__["AdminDashboardComponent"]],
        encapsulation: 2
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AdminDashboardContainerComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
...
//# sourceMappingURL=features-admin-dashboard-admin-dashboard-module-es5.js.map