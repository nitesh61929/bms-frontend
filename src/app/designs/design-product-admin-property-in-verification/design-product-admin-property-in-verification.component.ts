...
@Component({
  selector: 'app-design-product-admin-property-in-verification',
  templateUrl: './design-product-admin-property-in-verification.component.html',
  animations: [
...
export class DesignProductAdminPropertyInVerificationComponent implements OnInit {
