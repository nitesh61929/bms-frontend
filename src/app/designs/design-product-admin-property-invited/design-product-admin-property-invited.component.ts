...
@Component({
  selector: 'app-design-product-admin-property-invited',
  templateUrl: './design-product-admin-property-invited.component.html',
  animations: [
...
export class DesignProductAdminPropertyInvitedComponent implements OnInit {
