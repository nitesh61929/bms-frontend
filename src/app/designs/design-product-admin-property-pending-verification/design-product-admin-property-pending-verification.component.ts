...
@Component({
  selector: 'app-design-product-admin-property-pending-verification',
  templateUrl: './design-product-admin-property-pending-verification.component.html',
  animations: [
...
export class DesignProductAdminPropertyPendingVerificationComponent implements OnInit {
