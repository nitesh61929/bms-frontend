...
@Component({
  selector: "app-design-product-admin-user",
  templateUrl: "./design-product-admin-user.component.html",
  animations: [
...
export class DesignProductAdminUserComponent implements OnInit {
