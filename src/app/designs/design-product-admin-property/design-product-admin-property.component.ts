...
@Component({
  selector: "app-design-product-admin-property",
  templateUrl: "./design-product-admin-property.component.html",
  styleUrls: ["./design-product-admin-property.component.scss"],
  animations: [
...
export class DesignProductAdminPropertyComponent implements OnInit {
  selected = "domain";
